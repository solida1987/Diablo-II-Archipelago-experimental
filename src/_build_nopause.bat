...
cl.exe /nologo /MT /O2 /W3 /LD /TP /D_CRT_SECURE_NO_WARNINGS d2arch.c /Fe:D2Archipelago.dll /link /MAP:D2Archipelago.map user32.lib gdi32.lib kernel32.lib advapi32.lib
if %ERRORLEVEL% EQU 0 (
